...
exec代表**一组**可以替换当前进程的系统调用，它不会**创建**新的进程，而是用**新的程序序替换当前程序的数据和代码**。
...
p表示相对路径，如果不加l则需要传入绝对路径

e和l表示参数的传递方式，后者使用数组传递参数

![image-20250312225918527](./assets/image-20250312225918527.png)
